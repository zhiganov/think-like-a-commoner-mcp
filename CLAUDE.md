...
Railway, public, no auth. Live at https://think-like-a-commoner-mcp-production.up.railway.app. (GitHub auto-deploy not yet wired — connect via Railway dashboard if push-to-main auto-deploy is desired.)
